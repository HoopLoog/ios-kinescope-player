...
public extension KinescopeVideoDownloadable {
    ...
    /// Request downloadable link for video and start downloading with DRM support
    ///
    /// - parameter videoId: Video id
    /// - parameter url: web URL of video
    /// - parameter video: Optional video object for DRM support
    func enqueueDownload(videoId: String, url: URL, video: KinescopeVideo?) {
        // Default implementation calls the basic method for backward compatibility
